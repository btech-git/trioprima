...
use AppBundle\Grid\Report\PurchaseReturnHeaderGridType;
...
{
    /**
     * @Route("/grid", name="report_purchase_return_header_grid", condition="request.isXmlHttpRequest()")
     * @Method("POST")
    ...
    public function gridAction(Request $request)
    {
        ...
        return $this->render('report/purchase_return_header/grid.html.twig', array(
            'grid' => $grid->createView(),
        ));
    }

    /**
     * @Route("/", name="report_purchase_return_header_index")
     * @Method("GET")
     * @Security("has_role('ROLE_REPORT')")
     */
    ...
    /**
     * @Route("/export", name="report_purchase_return_header_export")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_REPORT')")
     */
