...
/**
 * @Route("/report/customer_sale_invoice")
 */
class CustomerSaleInvoiceController extends Controller
{
    /**
     * @Route("/grid", name="report_customer_sale_invoice_grid", condition="request.isXmlHttpRequest()")
     * @Method("POST")
    ...
    public function gridAction(Request $request)
    {
        ...
        return $this->render('report/customer_sale_invoice/grid.html.twig', array(
            'grid' => $grid->createView(),
        ));
    }

    /**
     * @Route("/", name="report_customer_sale_invoice_index")
     * @Method("GET")
     * @Security("has_role('ROLE_REPORT')")
     */
    public function indexAction()
    {
        return $this->render('report/customer_sale_invoice/index.html.twig');
    }

    /**
     * @Route("/export", name="report_customer_sale_invoice_export")
     * @Method({"GET", "POST"})
     * @Security("has_role('ROLE_REPORT')")
     */
