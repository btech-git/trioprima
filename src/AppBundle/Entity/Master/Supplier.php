...
class Supplier
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Account", inversedBy="suppliers")
     * @Assert\NotNull()
     */
    private $account;
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Transaction\PurchaseInvoiceHeader", mappedBy="supplier")
     */
    ...
    public function setPurchaseInvoiceHeaders(Collection $purchaseInvoiceHeaders = null) { $this->purchaseInvoiceHeaders = $purchaseInvoiceHeaders; }
}
