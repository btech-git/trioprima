...
class ExpenseHeaderRepository extends EntityRepository
{
    ...
    {
        $query = $this->_em->createQuery('SELECT t FROM AppBundle\Entity\Transaction\ExpenseHeader t WHERE t.codeNumberMonth = :codeNumberMonth AND t.codeNumberYear = :codeNumberYear ORDER BY t.codeNumberOrdinal DESC');
